...
class Dashboard extends React.Component {
  ...
  componentDidMount = () => {
    fetch(`https://f9f5a14b.ngrok.io/getDashboardInfo`, {
      method: 'POST',
      headers: {
  ...
  gotoSetting = () => {
    ...
    fetch('https://f9f5a14b.ngrok.io/duplicateWidget', {
      method: 'POST',
      headers: {
        'Content-type': 'application/json',
      },
  ...
  pauseWidget = (key) => {
    ...
    fetch(`https://f9f5a14b.ngrok.io/pauseWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  deleteWidget = () => {
    ...
    fetch(`https://f9f5a14b.ngrok.io/deleteWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
