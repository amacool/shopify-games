...
class Dashboard extends React.Component {
  ...
  componentDidMount = () => {
    fetch(`https://dev-frontend-tada.myshopify.com/getDashboardInfo`, {
      method: 'POST',
      headers: {
  ...
  gotoSetting = () => {
    ...
    fetch('https://dev-frontend-tada.myshopify.com/duplicateWidget', {
      method: 'POST',
      headers: {
        'Content-type': 'application/json',
      },
  ...
  pauseWidget = (key) => {
    ...
    fetch(`https://dev-frontend-tada.myshopify.com/pauseWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  deleteWidget = () => {
    ...
    fetch(`https://dev-frontend-tada.myshopify.com/deleteWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
