...
class Dashboard extends React.Component {
  ...
  componentDidMount = () => {
    fetch(`https://9a99fd6d.ngrok.io/getDashboardInfo`, {
      method: 'POST',
      headers: {
  ...
  gotoSetting = () => {
    ...
    fetch('https://9a99fd6d.ngrok.io/duplicateWidget', {
      method: 'POST',
      headers: {
        'Content-type': 'application/json',
      },
  ...
  pauseWidget = (key) => {
    ...
    fetch(`https://9a99fd6d.ngrok.io/pauseWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  deleteWidget = () => {
    ...
    fetch(`https://9a99fd6d.ngrok.io/deleteWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
