...
class Dashboard extends React.Component {
  ...
  componentDidMount = () => {
    fetch(`https://ee6dcb3e.ngrok.io/getDashboardInfo`, {
      method: 'POST',
      headers: {
  ...
  gotoSetting = () => {
    ...
    fetch('https://ee6dcb3e.ngrok.io/duplicateWidget', {
      method: 'POST',
      headers: {
        'Content-type': 'application/json',
      },
  ...
  pauseWidget = (key) => {
    ...
    fetch(`https://ee6dcb3e.ngrok.io/pauseWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  deleteWidget = () => {
    ...
    fetch(`https://ee6dcb3e.ngrok.io/deleteWidget`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
